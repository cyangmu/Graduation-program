...
<div class="top">
	<div class="top1">
        ...
        <div class="top_info"><a id="logOut" href="#"><img src="images/zxtb.gif" style="border:0px;vertical-align:text-bottom"/> 退出系统</a></div>
    </div>
    <div class="top2">
    	<div class="shijian">
    		<img src="images/time2.png" valign="middle" /> &nbsp;
    		<span id="timeDiv"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    		${admin.user_typeDesc }：${admin.real_name}&nbsp;&nbsp;&nbsp;&nbsp;欢迎您进入进销存管理系统！
    	</div>
        <div class="user"></div>
    </div>
</div>
