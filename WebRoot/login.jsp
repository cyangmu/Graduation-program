...
<BODY>
<FORM id="info" name="info"  method="post" action="LoginInSystem.action"  style="width:100%">
<DIV id="UpdatePanel1" style="width:100%">
<DIV style="width:100%">
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0 style="margin:0px auto">
	<TBODY>
		<TR>
			<TD style="HEIGHT: 105px"><IMG src="images/login_1.jpg" border=0></TD>
		</TR>
		<TR>
			<TD background=images/login_4.jpg height=300>
