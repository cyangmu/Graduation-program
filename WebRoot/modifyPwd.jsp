...
$(document).ready(function(){
	 ...
	 $("#saveBtn").bind('click',function(){
		if($("#paramsUsers\\.user_pass").val()=='' || $("#user_rpass").val()==''){
			alert('新密码和确认密码不能为空');
			return;
		}
		if($("#paramsUsers\\.user_pass").val() != $("#user_rpass").val()){
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" valign="middle" /> &nbsp;<span id="MainTitle" style="">系统管理&gt;&gt;修改密码</span>
</div>
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        <tr>
          ...
          <td>
            <input type="password" id="paramsUsers.user_pass" name="paramsUsers.user_pass"  />
          </td>
        </tr>
        <tr>
